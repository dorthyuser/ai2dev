...
$getData = "SELECT * FROM `cluster` WHERE `email` = '$session_id'";
...
if (!empty($_POST['id'])) {
    $id = $_POST['id'];
    $delete_q = "DELETE FROM `cluster` WHERE `id` = '$id'";
    $delete_result = mysqli_query($conn, $delete_q);
    if ($delete_result) {
        $response = [
            'status' => 'success',
            'message' => 'Cluster Delete Successfully',
        ];
                            ...
                            <li>
                                <div class="btn-group">
                                    ...
                                    <ul class="dropdown-menu show">
                                        ...
                                        <li><a class="dropdown-item active" href="listcluster.php">List Cluster</a></li>
                                    </ul>
                                </div>
                            </li>
                            <li>
