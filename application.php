...
if (!empty($_POST['checkboxes']) && !empty($_POST['applicationName']) && !empty($_POST['masterIP']) && !empty($_POST['workerIP'])) {
    ...
    $insertData = "INSERT INTO `application`(`infrastructure`, `email`, `applicationname`, `masternodeip`, `workernodeip`) VALUES ('$inf_encode','$session_id','$applicationName','$masterIP','$workerIP')";
...
<body>
                            ...
                            <li>
                                <div class="btn-group">
                                    ...
                                    <ul class="dropdown-menu show">
                                        <li><a class="dropdown-item active" href="application.php">New Application</a>
                                        </li>
                    ...
                    <div class="d-flex flex-column gap-4">
                        <div class="d-flex flex-column gap-4 pb-5 dark_background">
                            <div
                                ...
                                <button class="sign_btn" onclick="addcluster()">Add new applications <i
                            ...
                            <div class="know_more">
                                <div
                                    ...
                                    <div class="d-flex flex-column gap-3">
                                        ...
                                        <p>Applications is a scalable container-based cloud system, ready to run
                                            your
                                            applications in a fault tolerant way.</p>
                                    </div>
                                    <button class="learn_btn" onclick="addcluster()">Launch my first application <i
                                ...
                                <div class="d-flex flex-column gap-3">
                                    <ul class="d-flex flex-column gap-3">
                                        <li>
                                            ...
                                            <input id="application_name" type="text" name="application_name" required />
                                        </li>
                                        <li>
    ...
    <script>
        ...
        function submitFrom() {
            ...
            if (applicationName === '' || masterIP === '' || workerIP === '' ) {
