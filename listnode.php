...
$getData = "SELECT * FROM `node` WHERE `email` = '$session_id'";
...
if (!empty($_POST['id'])) {
    $id = $_POST['id'];
    $delete_q = "DELETE FROM `node` WHERE `id` = '$id'";
                            ...
                            <li>
                                <div class="btn-group">
                                    ...
                                    <ul class="dropdown-menu show">
                                        ...
                                        <li><a class="dropdown-item active" href="listnode.php">List Nodes</a></li>
                                    </ul>
                                </div>
                            </li>
                            <li>
                            ...
                            <li>
                                <div class="btn-group">
                                    ...
                                    <ul class="dropdown-menu">
                                        ...
                                        <li><a class="dropdown-item" href="listloadbalancer.php">List Load Balancer</a></li>
                                    </ul>
                                </div>
                            </li>
                            <li>
