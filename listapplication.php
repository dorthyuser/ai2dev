...
$getData = "SELECT * FROM `application` WHERE `email` = '$session_id'";
...
if (!empty($_POST['id'])) {
    $id = $_POST['id'];
    $delete_q = "DELETE FROM `application` WHERE `id` = '$id'";
                            ...
                            <li>
                                <div class="btn-group">
                                    ...
                                    <ul class="dropdown-menu show">
                                        ...
                                        <li><a class="dropdown-item active" href="listapplication.php">List
                                                Applications</a></li>
                                    </ul>
                                </div>
                            </li>
