...
if (!empty($_POST['checkboxes']) && !empty($_POST['nodeName']) && !empty($_POST['masterIP']) && !empty($_POST['workerIP'])) {
    ...
    $insertData = "INSERT INTO `node`(`infrastructure`, `email`, `nodename`, `masternodeip`, `workernodeip`) VALUES ('$inf_encode','$session_id','$nodeName','$masterIP','$workerIP')";
                            ...
                            <li>
                                <div class="btn-group">
                                    ...
                                    <ul class="dropdown-menu">
                                        <li><a href="node.php" class="dropdown-item " href="#">New cluster</a>
                                        </li>
                            ...
                            <li>
                                <div class="btn-group">
                                    ...
                                    <ul class="dropdown-menu show">
                                        <li><a class="dropdown-item active" href="node.php">New Node</a></li>
            ...
            <div class="d-flex flex-column gap-4 w-100 z-3 dark_background">
                ...
                <div class="main_content px-md-4 px-2">
                    <div class="d-flex flex-column gap-4">
                        <div class="d-flex flex-column gap-4 pb-5 dark_background">
                            <div
                                class="d-flex flex-md-row flex-column align-items-md-center gap-3 justify-content-between">
                                <h1>Nodes</h1>

                                <button class="sign_btn" onclick="addcluster()">Add new nodes <i
                            ...
                            <div class="know_more">
                                <div
                                    ...
                                    <div class="d-flex flex-column gap-3">
                                        <h5>Hi <?php echo $DataArray['name'] ?>, let's get started</>
                                            <p>nodes is a scalable container-based cloud system, ready to run
                                                your
                                                applications in a fault tolerant way.</p>
                                    </div>
                                    <button class="learn_btn" onclick="addcluster()">Launch my first node <i
                            ...
                            <div class="d-flex flex-column gap-4">
                                ...
                                <div class="d-block">
                                    <ul class="d-flex flex-wrap gap-3">
                                        <li>
                                            <input type="checkbox" id="aws" name="checkbox" value="AWS"
                                                onclick="onlyOne(this)">
                                            <label for="aws">AWS</label>
                                        </li>
                                        <li>
                                            <input type="checkbox" id="azure" name="checkbox" value="AZURE"
                                                onclick="onlyOne(this)">
                                            <label for="azure">AZURE</label>
                                        </li>
                                        <li>
                                            <input type="checkbox" id="gcp" name="checkbox" value="GCP"
                                                onclick="onlyOne(this)">
                                            <label for="gcp">GCP</label>
                                        </li>
                                        <li>
                                            <input id="vps" name="checkbox" type="checkbox" value="VPS"
                                                onclick="onlyOne(this)">
                                ...
                                <div class="d-flex flex-column gap-3">
                                    <ul class="d-flex flex-column gap-3">
                                        <li>
                                            ...
                                            <input id="node_name" type="text" name="node_name" required />
                                        </li>
                                        <li>
                                            <label for="master_ip">Master Node IP :</label>
                                            <input type="text" id="master_ip" name="master_ip"
                                                pattern="^(([0-9]{1,3}\.){3}[0-9]{1,3}|([0-9a-fA-F]{1,4}:){7}[0-9a-fA-F]{1,4})$"
                                                required>
                                        </li>
                                        <li>
                                            <label for="worker_ip">Worker Node IP :</label>
                                            <input type="text" id="worker_ip" name="worker_ip"
                                                pattern="^(([0-9]{1,3}\.){3}[0-9]{1,3}|([0-9a-fA-F]{1,4}:){7}[0-9a-fA-F]{1,4})$"
                                                required>
                                        </li>
            ...
            $.ajax({
                ...
                success: function (response) {
                    ...
                    if (response.status === 'success') {
                        ...
                        setTimeout(function () {
                            window.location.href = 'listnode.php';
                        }, 500);
                    }
                }
            });
