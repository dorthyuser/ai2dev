...
if (!empty($_POST['checkboxes']) && !empty($_POST['loadbalancerName']) && !empty($_POST['masterIP']) && !empty($_POST['workerIP'])) {

    $infrastructure = $_POST['checkboxes'];
    $loadbalancerName = $_POST['loadbalancerName'];
    ...
    $insertData = "INSERT INTO `loadbalancer`(`infrastructure`, `email`, `loadbalancername`, `masternodeip`, `workernodeip`) VALUES ('$inf_encode','$session_id','$loadbalancerName','$masterIP','$workerIP')";
    ...
    if ($resultInsert) {
        $response = [
            'status' => 'success',
            'message' => 'Load Balancer Create successfully',
        ];
        echo json_encode($response);
        exit;
    } else {
        echo "Error Create Load Balancer";
    }
...
<body>
                            ...
                            <li>
                                <div class="btn-group">
                                    ...
                                    <ul class="dropdown-menu show">
                                        <li><a class="dropdown-item active" href="loadbalancer.php">New Load
                                                Balancer</a>
                                        </li>
                    ...
                    <div class="d-flex flex-column gap-4">
                        ...
                        <div class="d-flex flex-column gap-4 pb-5 dark_background">
                            <div
                                ...
                                <button class="sign_btn" onclick="addcluster()">Add new Load Balancers <i
                                ...
                                <div
                                    ...
                                    <div class="d-flex flex-column gap-3">
                                        <h5>Hi <?php echo $DataArray['name'] ?>, let's get started</>
                                            <p>Load Balancers is a scalable container-based cloud system, ready to
                                                run
                                                your
                                                applications in a fault tolerant way.</p>
                                    </div>
                                    <button class="learn_btn" onclick="addcluster()">Launch my first loadbalancer <i
                            ...
                            <form action="" class="d-flex flex-column gap-4">
                                <div class="d-flex flex-column gap-3">
                                    <ul class="d-flex flex-column gap-3">
                                        <li>
                                            <label for="loadbalancer_name">Load Balancers Name :</label>
                                            <input id="loadbalancer_name" type="text" name="loadbalancer_name"
                                                required />
                                        </li>
                                        <li>
    ...
    <script>
        ...
        function submitFrom() {
            ...
            const loadbalancerName = document.getElementById('loadbalancer_name').value;
            ...
            if (loadbalancerName === '' || masterIP === '' || workerIP === '') {
            ...
            $.ajax({
                ...
                success: function (response) {
                    ...
                    if (response.status === 'success') {
                        ...
                        setTimeout(function () {
                            window.location.href = 'listloadbalancer.php';
                        }, 500);
                    }
                }
            });
